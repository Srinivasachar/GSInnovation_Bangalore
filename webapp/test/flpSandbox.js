		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Intelligent technical Articrafts",
									"targetURL": "#IntelligenttechnicalArticrafts-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"IntelligenttechnicalArticrafts-display": {
								"semanticObject": "IntelligenttechnicalArticrafts",
								"action": "display",
								"description": "Intelligent technical Articrafts",
								"title": "Intelligent technical Articrafts",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=gs.innovation.gsinnovation",
									"url": sap.ui.require.toUrl("gs/innovation/gsinnovation")
								}
							}
						}
					}
